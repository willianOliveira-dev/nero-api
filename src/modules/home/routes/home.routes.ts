...
export const homeRoutes: FastifyPluginAsyncZod = async (app) => {
    ...
    app.get('/home', {
        schema: {
            ...
            operationId: 'getHome',
            response: {
                200: z.object({ data: z.array(homeSectionSchema) }),
            },
        },
    ...
    app.get('/home/:id', {
        schema: {
            ...
            response: { 200: z.object({ data: homeSectionSchema }) },
        },
    ...
    app.get('/admin/home', {
        schema: {
            ...
            response: {
                200: z.object({ data: z.array(adminSectionSchema) }),
            },
        },
    ...
    app.post('/admin/home', {
        schema: {
            ...
            response: { 201: z.object({ data: adminSectionSchema }) },
        },
        preHandler: [app.authenticate],
    ...
    app.patch('/admin/home/:id', {
        schema: {
            ...
            response: { 200: z.object({ data: adminSectionSchema }) },
        },
        preHandler: [app.authenticate],
    ...
    app.post('/admin/home/reorder', {
        schema: {
            ...
            response: {
                200: z.object({ data: z.object({ reordered: z.boolean() }) }),
            },
        },
        preHandler: [app.authenticate],
